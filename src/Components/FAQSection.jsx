...
const faqs = [
  {
    question: "Subnex IT কী?",
    answer:
      "Subnex IT একটি অনলাইন ভিত্তিক ডিজিটাল সার্ভিস প্ল্যাটফর্ম, যেখানে ব্যবহারকারীরা সহজ ও নিরাপদ উপায়ে বিভিন্ন ডিজিটাল সাবস্ক্রিপশন ও সার্ভিস গ্রহণ করতে পারেন।",
  },
  {
  ...
  {
    question: "Subnex IT কি নিরাপদ ও বিশ্বাসযোগ্য?",
    answer:
