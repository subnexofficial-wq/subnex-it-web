import { ShieldCheck, Lock, EyeOff, FileText, Bell, Mail, CheckCircle2 } from "lucide-react";
    ...
    <div className="bg-gray-50 min-h-screen pb-20 font-sans text-gray-800">
      ...
      <div className="bg-black text-white py-16 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="mt-6 inline-block bg-white/10 px-4 py-1 rounded-full text-xs font-medium text-gray-300">
            সর্বশেষ হালনাগাদ: ২০ ডিসেম্বর, ২০২৫
          </div>
        </div>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-4 -mt-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 leading-tight">আপনার সকল তথ্য এনক্রিপ্টেড সার্ভারে সংরক্ষিত থাকে।</p>
            </div>
          </div>
          ...
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 leading-tight">আমরা কখনোই তৃতীয় পক্ষের কাছে তথ্য বিক্রি করি না।</p>
            </div>
          </div>
          ...
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 leading-tight">লেনদেনের নিরাপত্তার জন্য আমাদের সাইট SSL এনক্রিপ্টেড।</p>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-1 gap-12">
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="space-y-4">
                  <p className="text-gray-600">আমরা শুধুমাত্র সেই তথ্যগুলোই সংগ্রহ করি যা আপনাকে সেবা প্রদানের জন্য প্রয়োজন:</p>
                  <ul className="space-y-3">
                    {['ইমেইল ঠিকানা', 'ফোন নাম্বার', 'একাউন্ট সংক্রান্ত মৌলিক তথ্য'].map((item, i) => (
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              <div className="space-y-4">
                ...
                <p className="text-gray-600 text-sm leading-relaxed">
                  আপনার তথ্য শুধুমাত্র একাউন্ট তৈরি, ডিজিটাল সার্ভিস ডেলিভারি এবং কাস্টমার সাপোর্টের প্রয়োজনে ব্যবহার করা হয়। আমরা আপনার গোপনীয়তাকে সম্মান করি এবং কোনো অননুমোদিত ব্যবহারের অনুমতি দেই না।
                </p>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="p-6 bg-gray-50 rounded-2xl border border-gray-100">
                    <h3 className="font-bold flex items-center gap-2 mb-2"><Bell size={18} className="text-blue-600" /> নীতিমালা পরিবর্তন</h3>
                    <p className="text-sm text-gray-500 italic">Subnex যেকোনো সময় এই প্রাইভেসি পলিসি পরিবর্তন বা হালনাগাদ করার অধিকার সংরক্ষণ করে।</p>
                </div>
                <div className="p-6 bg-gray-50 rounded-2xl border border-gray-100">
                    <h3 className="font-bold flex items-center gap-2 mb-2"><FileText size={18} className="text-blue-600" /> কুকিজ (Cookies)</h3>
                    <p className="text-sm text-gray-500 italic">ওয়েবসাইটের পারফরম্যান্স উন্নত ও দ্রুত লোড নিশ্চিত করার জন্য আমরা সাময়িকভাবে কুকিজ ব্যবহার করি।</p>
                </div>
            </div>
            ...
            <div className="bg-black rounded-3xl p-8 text-white flex flex-col md:flex-row justify-between items-center gap-6">
              <div className="text-center md:text-left">
                ...
                <p className="text-gray-400 text-sm">প্রাইভেসি সংক্রান্ত যেকোনো তথ্যের জন্য সরাসরি যোগাযোগ করুন</p>
              </div>
              <a 
        ...
        <div className="mt-8 text-center text-gray-400 text-[10px] uppercase tracking-[0.2em]">
          © 2025 Subnex Digital Service Platform. All Rights Reserved.
        </div>
      </div>
    </div>
  );
