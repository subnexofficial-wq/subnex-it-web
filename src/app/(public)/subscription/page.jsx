...
export const metadata = {
  title: "Subscription | Subnex",
  description:
    "Explore Subnex subscription plans for premium services, renewals, and ongoing support.",
  alternates: {
  ...
  return (
    <div className="pt-6 min-h-[70vh]">
      {subscriptionProducts.length > 0 ? (
        <DynamicProductSection products={subscriptionProducts} sectionTitle="SUBSCRIPTION" />
      ) : (
        <div className="flex flex-col items-center justify-center py-24 px-4 text-center">
          ...
          <h2 className="text-2xl font-bold text-slate-800 mb-3">No Subscriptions Found</h2>
          <p className="text-slate-500 mb-8 max-w-sm mx-auto">
            Currently, there are no active subscription plans available. Please check back later or
