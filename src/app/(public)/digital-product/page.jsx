...
export const metadata = {
  title: "Digital Product | Subnex",
  description:
    "Downloadable digital products from Subnex including tools, assets, and ready-to-use resources.",
  alternates: {
    canonical: `${baseUrl}/digital-product`,
  },
};
  ...
  return (
    <div className="pt-6 min-h-[60vh]">
      {digitalProducts.length > 0 ? (
        <DynamicProductSection products={digitalProducts} sectionTitle="DIGITAL PRODUCTS" />
      ) : (
        <div className="flex flex-col items-center justify-center py-20 px-4 text-center">
          ...
          <p className="text-gray-500 mb-6">
            Sorry, we could not find any products in the Digital Products category right now.
          </p>
          <Link
            href="/"
